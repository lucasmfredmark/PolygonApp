...
<html>
    ...
    <body>
        <div id="top">
            ...
            <div id="navigation">
                <div class="wrapper">
                    <h2>Reporting a damage to building: <%= b.getBuildingName() %></h2>
                    <ul>
        ...
        <div id="content">
            <div class="wrapper">
                <!-- BREADCRUMBS -->
                <p class="breadcrumbs"><a href="/PolygonApp/buildings.jsp">Your buildings</a> &raquo; <a href="/PolygonApp/viewbuilding.jsp?buildingId=<%= buildingId %>">Building information</a> &raquo; Report damage</p>
